//
//  KZ_ImagePickerImageViewController.h
//  KZ_PhotoAlbum
//
...
@class KZ_Image;
@class KZ_ImagePickerImageViewController;

@interface KZ_ImagePickerImageViewController : UIViewController <UIScrollViewDelegate> {
